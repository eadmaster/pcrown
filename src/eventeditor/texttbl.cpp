...
{
   0x8140, 0x81A5, 0x818B, 0x8145, 0x8148, 0x8149, 0x8151, 0x8158, // 0x000 ( 、。*?!_#)
   0x815B, 0x8160, 0x8169, 0x816A, 0x819E, 0x8189, 0x817C, 0x8193, // 0x008 (+~()「」-%)
   0x818A, 0x824F, 0x8250, 0x8251, 0x8252, 0x8253, 0x8254, 0x8255, // 0x010 (♀0123456)
   0x8256, 0x8257, 0x8258, 0x8260, 0x8261, 0x8262, 0x8266, 0x826A, // 0x018 (789.....)
   ...
   0x8278, 0x8279, 0x979D, 0x97A0, 0x97A2, 0x97A3, 0x97A4, 0x97A6, // 0x3D8 (Y-Z, symbols: ,."':&)
