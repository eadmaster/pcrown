...
curl.exe -kL "https://raw.githubusercontent.com/eadmaster/pcrown/refs/heads/master/src/buildcd/Princess%%20Crown%%20(Japan)%%20(1M)%%20(English)%%20(iso).cue" -o "Princess Crown (Japan) (1M) (English).cue"
