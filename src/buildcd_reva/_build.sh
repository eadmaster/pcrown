...
# cleanup
rm "Princess Crown (Japan) (Rev A) (11M) (Track 01) (English).iso"
rm "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso"
rm "$PATCHED_IMAGE_FILE"
# rm *.eng

# convert data bin track to iso
iat "Princess Crown (Japan) (Rev A) (11M) (Track 01).bin" "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso"
cp "Princess Crown (Japan) (Rev A) (11M) (Track 01).bin" "$PATCHED_IMAGE_FILE" 
...
#xdelta3 -S none -f -e -s "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso"  "Princess Crown (Japan) (Rev A) (11M) (Track 01) (English).iso"  "Princess.Crown.Japan.1M.Track.01.iso.xdelta"
