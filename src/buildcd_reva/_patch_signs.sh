...
7z e -y "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso" '*.CHR'  > /dev/null
7z e -y "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso" '*.PAK'  > /dev/null
...
7z e -y "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso" COCKPIT.CHB   > /dev/null
...
7z e -y "Princess Crown (Japan) (Rev A) (11M) (Track 01).iso" '*.PRG'  > /dev/null
