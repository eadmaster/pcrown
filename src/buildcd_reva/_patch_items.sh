...
sfk setbytes 0.BIN $((0x70603+0x8)) 0xF -yes  # X position of the price in the store (max=1A)
...
# RAM: 6022B8F
#sfk setbytes 0.BIN 0x1eadf 0x01 -yes
...
sfk setbytes 0.BIN 0xA4137  "& ATLUS,1997  T-ENG V1.1b+LT"  -yes
